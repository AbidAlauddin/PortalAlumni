<footer id="footer">
        ...
        <div class="footer-col footer-col1">
            <div class="footer-logo">
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
                    ...
                    <path d="M20 10L25 18H15L20 10Z" fill="#10b981"/>
                    <rect x="17" y="18" width="6" height="12" fill="#10b981"/>
                </svg>
                <h3>Hey Job</h3>
            </div>
            <p class="footer-desc">Connecting talent with opportunity. Your next career move starts here. Made with <span class="heart">❤</span> for job seekers worldwide.</p>
            <div class="social">
    ...
    <div class="footer-bottom">
        <div class="footer-bottom-container">
            <p class="copyright">© 2024 Hey Job. All Rights Reserved</p>
